...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		new Robot().mouseMove(180, 90);
		
		//4. Add a mouse motion listener using:
		addMouseMotionListener(this);
		
	}
//mouseColor != -1 || mouseColor != -3335383 || mouseColor != -7242378
	@Override
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("393824__sirbedlam__violin-scare.wav"));
